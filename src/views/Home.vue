...
<script>
import HomeClient from "../ApiClient/HomeClient.js";
...
export default {
	...
	methods: {
		...
		async buscarDados() {
			let resposta = (await HomeClient.buscarDados()).data;
			this.qtdClientes = resposta.clientesCad;
			this.qtdProdutos = resposta.produtosCad;
			this.qtdVendas = resposta.vendasCad;
			this.valorVendas = resposta.vendasValor.toFixed(2);
			this.bestSellerCat = resposta.categoriaMais;
			this.leastSoldCat = resposta.categoriaMenos;
			this.bestSellerProduct = resposta.produtoMais;
			this.leastSoldProduct = resposta.produtoMenos;
		},
	},
