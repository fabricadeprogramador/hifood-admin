...
=======
    <template v-slot:item.detalhes>
      <v-icon small class="mr-2" @click="dialog = true"> mdi-magnify </v-icon>
      <Detalhes :dialog.sync="dialog" />
    </template>
>>>>>>> 74fae42ad52cc02f9557cfd1d8764b3398747037

    <template v-slot:item.compras="{ item }">
      <v-icon small @click="dialog = true(item)"> mdi-cart-outline </v-icon>
      <Compras />
    </template>
